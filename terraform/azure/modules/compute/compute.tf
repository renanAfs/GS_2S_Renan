...
resource "azurerm_public_ip" "vm03_pip_public1a" {
...
resource "azurerm_network_interface" "vm03_nic_public1a" {
  ...
  resource_group_name = var.rgname
    ip_configuration {
        ...
        private_ip_address_allocation = "Dynamic"
        public_ip_address_id          = azurerm_public_ip.vm03_pip_public1a.id
    }
}
...
resource "azurerm_public_ip" "vm04_pip_public1a" {
...
resource "azurerm_network_interface" "vm04_nic_public1a" {
  ...
  resource_group_name = var.rgname
    ip_configuration {
        ...
        subnet_id                     = var.snvnetapub1b
        private_ip_address_allocation = "Dynamic"
        public_ip_address_id          = azurerm_public_ip.vm04_pip_public1a.id
    }
}
